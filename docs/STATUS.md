...
| Working branch | `master`. **Two commits are committed and not yet pushed**: the swappable-parameters lint flip and M1-09, both of 2026-09-20. Everything before them is pushed, M1-86, M1-07 and M1-08 included, verified rather than assumed. `git fetch && git switch master` is all another machine needs. **Five merged branches can be deleted** whenever somebody feels like it, local and remote: `clang-23-2026-09`, `consistency-fixes-2026-09-13`, `docs-reorg`, `pre-docs-reorg-2026-09-09`, `review-fixes-2026-09` |
