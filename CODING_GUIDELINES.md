...
**Tests.** You already have 3,577 assertions on the two-body core, and — this is
...
- The physics is testable without a GPU, which is why you have 3,577 assertions
  and not six.
...
all 3,577 assertions. ThreadSanitizer is waiting there for the day the physics
